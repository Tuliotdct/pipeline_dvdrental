...
def create_gold_for_table(partition_date = None):

    # Transform data from the silver layer and send to the gold Layer
    bucket = get_variable("BUCKET_NAME", default=os.getenv("BUCKET_NAME"))
    ...
    try:
        ...
        logger.error(f'Failed to load parquet file into S3')
